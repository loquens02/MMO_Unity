...
public class UI_Inven : UI_Scene
{
    ...
    public override void Init()
    {
        ...
        // 임의로 8개 추가해서 GridPanel 밑에 넣어주기. TODO 나중에는 인벤토리 정보 참조
        for(int i=0; i<8; i++)
        {
            // 인벤토리
            // null excception - Unity 에 UI_Inven_Item 프리팹이 없을 경우
            ...
            // UI_Inven_Item invenItem = Util.GetOrAddComponent<UI_Inven_Item>(item); //같은 기능
